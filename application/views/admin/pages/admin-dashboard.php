...
foreach ($products as $product) {
    ...
    $threshold = 0.3 * $quantity;

    if ($availableQuantity <= $threshold && $availableQuantity !== '0') {
        echo "
        <script>
        $(document).ready(function() {
            $(document).Toasts('create', {
                ...
                subtitle: 'Required :". $product['quantity'] . "',
                body: 'Quantity is less then 30% , available quantity is :<b> " . $product['available'] . "</b>',
            });
        });
        </script>";
    ...
    if ( $availableQuantity == '0') {
        ...
        $(document).ready(function() {
            $(document).Toasts('create', {
                ...
                title: 'Product : " . $product['product'] . "',
                subtitle: 'Required :". $product['quantity'] . "',
                body: ' available quantity is :<b> " . $product['available'] . "</b>',
            });
        });
        </script>";
