<div class="card">
   <div class="card-header ">
      ...
      <a href=""><button type="button" class="btn flot-right mr-4 bg-gradient-primary">Done Work List</button></a>
      <a href=""><button type="button" class="btn flot-right mr-4 bg-gradient-primary">Canceled Work List</button></a>
