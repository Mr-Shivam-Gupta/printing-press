      ...
      <table id="example1" class="table table-bordered table-striped">
         <thead>
            <tr>
               ...
               <th width="40" class="text-center">Date</th>
            ...
            <tr>
               ...
               <td class="text-center">
                  <a href="<?php echo base_url(); ?>Admin/workView/<?php echo $work['id']; ?>"><button type="button" title="View"
                     class="btn  bg-gradient-primary"><i class="fas fa-eye"></i> View</button></a>
                  </a>
                  <?php if ($work['status'] == '1') { ?>
                  <a href="<?php echo base_url('Admin/deliverd/').$work['id'];?> " class="delivered"><button <?php if($work['is_delivered']==1){ echo "disabled";}?> type="button"class="btn  bg-gradient-success  "><i
                     class="fa fa-thumbs-up"></i> Delivery <?php if($work['is_delivered']==1){ echo "Done";}?></button></a>
                  </a>
                  <?php }?>
               </td>
            </tr>
...
<script>
   $(document).ready(function() {
    ...
    $(".delivered").click(function(event) {
             ...
             Swal.fire({
                 title: "Confirmation",
                 text: "Work delivered to customer?",
                 icon: "question",
                 showCancelButton: true,
                 confirmButtonColor: "#28a745",
                 cancelButtonColor: "#d33",
                 confirmButtonText:
    '<i class="fa fa-thumbs-up"></i> Yes, Delivered!'
             }).then((result) => {
